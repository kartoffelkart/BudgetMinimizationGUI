 ...
 * 
 * Code from Joachim Van der Auwera
 * Webseite http://blog.progs.be/550/java-time-hibernate
 */
...
public class LocalDateUserType implements EnhancedUserType, Serializable {
    ...
    public void nullSafeSet(PreparedStatement preparedStatement, Object value, int index, SessionImplementor session)
        ...
        if (value == null) {
            ...
            Date time = Date.from(((LocalDate) value).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant());
