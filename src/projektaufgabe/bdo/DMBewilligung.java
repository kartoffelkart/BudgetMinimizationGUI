...
@Entity
@Table(name = "dmbewilligung")
public class DMBewilligung implements Serializable {
    ...
    @OneToMany(mappedBy = "dmbewilligung")
    private Set<DMFinanzierung> dmfinanzierungen;

    
    public DMBewilligung() {
    }

    public DMBewilligung(String bewilligungsNr) {
  ...
  public StringProperty getBewilligungsNrProperty() {
    ...
    public String toString() {
        return "DMBewilligung{" +  this.getBewilligungsNr();
    }
